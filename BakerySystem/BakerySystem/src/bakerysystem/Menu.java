...
private int[] ccakenum = new int[7];
...
private Stack<String> viewClearedOrder = new Stack<>();

    
    public Menu() {
        initComponents();
        bttview.setVisible(false);
...
cupcakeimage.setIcon (new ImageIcon (image1));
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 580, 170, 30));
        ...
        jPanel1.add(bttconfirmorder, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 540, 170, 30));
        ...
        jPanel1.add(bttclearorder, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 540, 170, 30));
        ...
        bttview.setBackground(new java.awt.Color(255, 204, 204));
        bttview.setFont(new java.awt.Font("Tempus Sans ITC", 1, 11)); // NOI18N
        bttview.setText("View Cleared Order");
        bttview.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bttviewActionPerformed(evt);
            }
        });
        jPanel1.add(bttview, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 580, 170, 30));
    ...
    private void pushStack(int index, boolean isCupcake){
            if(isCupcake){
                if(ccakenum[index] > 0){
                viewClearedOrder.push(cupcakeName[index] + ": " + ccakenum[index]);
            }
        }else{
            if(num[index] > 0){
                viewClearedOrder.push(cakeName[index] + ": " + num[index]);
            }
        }
    }
    ...
    private void bttviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttviewActionPerformed
       ...
       StringBuilder vclearorders = new StringBuilder("");
       
       while(!viewClearedOrder.isEmpty()){
           vclearorders.append(viewClearedOrder.pop()).append("\n");
       }
       
       JOptionPane.showMessageDialog(this, vclearorders.toString(), "Viewing Your Cleared Orders", JOptionPane.INFORMATION_MESSAGE);
